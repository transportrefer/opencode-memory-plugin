...
3. Do not copy anything into OpenCode memory unless the user asks or it is clearly useful at the end of the task.
4. If promoting a Codex finding into OpenCode memory, use `memory_remember` and set `source="codex-memory"`.
